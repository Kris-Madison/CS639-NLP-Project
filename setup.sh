...
log ""
log "Next steps:"
log "  1. Activate the conda env:        conda activate agentbench"
log "  2. Copy .env.example → .env and add your API key"
log "  3. Start the environment stack:   bash scripts/start_env.sh"
log "  4. Run evaluation:                bash scripts/run_eval.sh [-m gpt-4o] [-t os-std] [-j 8]"
log ""
log "⚠️  Always run 'conda activate agentbench' before using any scripts."
log ""